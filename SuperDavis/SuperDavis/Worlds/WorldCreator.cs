    ...
    class WorldCreator
    {
        ...
        private void CreateBlockDictionary()
        {
            blockDictionary = new Dictionary<String, Action<float, float>>
            {
                ...
                { nameof(LeftCastleFloor), (x,y) => world.AddObject(new LeftCastleFloor(new Vector2(x, y))) },
                { nameof(MiddleCastleFloor), (x,y) => world.AddObject(new MiddleCastleFloor(new Vector2(x, y))) },
                { nameof(RightCastleFloor), (x,y) => world.AddObject(new RightCastleFloor(new Vector2(x, y))) },
                ...
                { nameof(DirtBlock), (x,y) => world.AddObject(new DirtBlock(new Vector2(x, y))) },
